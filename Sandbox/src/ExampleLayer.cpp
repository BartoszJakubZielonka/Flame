	...
	: Layer("ExampleLayer"), m_CameraController(1280.0f / 720.0f)
{
	...
	flame::Ref<flame::VertexBuffer> vertexBuffer = flame::VertexBuffer::Create(vertices, sizeof(vertices));
	...
	flame::Ref<flame::IndexBuffer> indexBuffer = flame::IndexBuffer::Create(indices, sizeof(indices) / sizeof(uint32_t));
	...
	flame::Ref<flame::VertexBuffer> squareVB = flame::VertexBuffer::Create(squareVertices, sizeof(squareVertices));
	squareVB->SetLayout({
		{ flame::ShaderDataType::Float3, "a_Position" },
	...
	flame::Ref<flame::IndexBuffer> squareIB = flame::IndexBuffer::Create(squareIndices, sizeof(squareIndices) / sizeof(uint32_t));
